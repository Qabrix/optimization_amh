...
class Population:
    ...
    def recombination(self):
        ...
        for i in range(0, len(permutation), 2):
            ...
            new_generation.append(Inhabitant(selection[permutation[i]][:pivot1] + selection[permutation[i+1]][pivot1:pivot2]+ selection[permutation[i]][pivot2:]))
            new_generation.append(Inhabitant(selection[permutation[i+1]][:pivot1] + selection[permutation[i]][pivot1:pivot2]+ selection[permutation[i+1]][pivot2:]))
