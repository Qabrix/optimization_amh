...
def init_population(dic, puzzles, size, all_puzzle_keys, search_range):
    return Population(puzzles, size, all_puzzle_keys, search_range)
...
def main():
    ...
    population = init_population(dic, puzzles, 100, all_puzzle_keys, search_range)
