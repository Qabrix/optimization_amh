...
class Population:
    ...
    def make_selection(self, percentage=0.75, elite_percentage=0.8):
        selection = []
    ...
    def mutate(self, min_swap_probability=0.1, max_swap_probability=0.2, inverse_probability=0.01, random_probability=0.01, shift_probability=0.1):
