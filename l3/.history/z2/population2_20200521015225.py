...
class Population:
    ...
    def recombinate(self):
        ...
        for i in range(0, len(permutation)):
            ...
            if selection[permutation[i % len(permutation)]] != selection[permutation[(i + 1) % len(permutation)]]:
                new_word = (
    ...
    def mutate(self, min_swap_probability=0.2, max_swap_probability=0.8, inverse_probability=0.1, random_probability=0.1):
