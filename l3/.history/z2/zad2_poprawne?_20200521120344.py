...
def init_population(dic, puzzles, size, all_puzzle_keys, starter_words):
    return Population(puzzles, size, all_puzzle_keys, starter_words)
...
def search(dic, puzzles, all_puzzle_keys, t, starter_words):   
    ...
    population = init_population(dic, puzzles, 100, all_puzzle_keys, starter_words)
