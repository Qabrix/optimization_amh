...
class Particle:
    ...
    def update_velocity(self, omega, fip, fig, g):
        ...
        for i in range(len(self.velocity)):
            new_velocity.append(omega*self.velocity[i] + fip*r[0]*(self.best_x[i]-self.x[i]))
...
class Swarm:
    ...
    def update_particles_velocity(self, omega=1, fip=1, fig=1):
        for particle in self.particles:
            particle.update_velocity(omega, fip, fig)
