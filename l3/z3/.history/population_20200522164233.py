...
class Population:
    def __init__(self, population_size, all_puzzles, starter_words, moves_manager):
    ...
    def _gen_generation(self, starter_words):
        ...
        for _ in range(len(starter_words), self.population_size):
            word = self.moves_manager.random_moves(moves_manager.start_pos, moves_manager.grid, moves_manager.n, moves_manager.m, (moves_manager.n-2)*(moves_manager.m-2))
