...
class Population:
    ...
    def sorted_generation(self, reverse=True):
        ...
        return res
    # zmiana sposobow wybory najgorszych
    def make_selection(self, elite_percentage, percentage=0.75, reverse=True):
        selection = []
        sorted_generation = self.sorted_generation(reverse)
    ...
    def recombinate(self, elite_percentage=0.6):
        selection = self.make_selection(elite_percentage, reverse=False)
